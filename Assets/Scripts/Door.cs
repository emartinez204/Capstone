...
public class Door : MonoBehaviour
{
	...
	// Needs to be public because Detection.cs has to access it
	...
	void Start ()
	{
		...
		if (HingeType == TypeOfHinge.Centered) {
			...
			//hinge.transform.position = new Vector3 (0, 0, -transform.position.z);
			...
			// HINGE POSITIONING
			//HingePosCopy.z = -transform.localScale.z / 4;
